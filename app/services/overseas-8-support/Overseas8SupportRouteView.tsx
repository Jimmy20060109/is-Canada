    ...
    <main className="bg-[#f3f4f6] text-zinc-900">
      <section className="mx-auto max-w-7xl px-6 pb-10 pt-16 md:pt-20">
        <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm md:p-12">
          <p className="text-sm font-semibold uppercase tracking-[0.15em] text-[#7f2542]">Overseas Safeguard</p>
          <h1 className="mt-4 text-4xl font-black tracking-tight text-[#12285f] md:text-6xl">3.4 海外 8 大守护</h1>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-10">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {supportGroups.map((group) => (
            <article
              key={group.title}
              className="rounded-3xl border border-zinc-200 bg-[#fafbff] p-6 shadow-sm"
            >
