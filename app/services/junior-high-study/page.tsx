  ...
  return (
    <main className="bg-gradient-to-b from-rose-50 via-white to-orange-50">
      <section className="mx-auto max-w-7xl px-6 pb-10 pt-16 md:pt-20">
        <div className="rounded-3xl border border-rose-100 bg-white p-8 shadow-[0_25px_90px_-45px_rgba(185,28,28,0.45)] md:p-12">
          <p className="text-sm font-semibold uppercase tracking-[0.15em] text-rose-500">Study Abroad Path</p>
          <h1 className="mt-4 text-4xl font-black tracking-tight text-zinc-900 md:text-6xl">3.1 低龄留学</h1>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-10">
        ...
        <div className="mt-6 grid gap-3">
          {troubles.map((item) => (
            <div
              key={item}
              className="flex items-start gap-3 rounded-2xl border border-rose-100 bg-rose-50/90 px-5 py-4 text-zinc-800"
            >
              <span className="mt-0.5 text-lg font-black leading-none text-rose-600">×</span>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-10">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {pathSteps.map((step) => (
            <article
              key={step.title}
              className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-[0_18px_60px_-40px_rgba(24,24,27,0.45)]"
            >
              <p className="inline-flex rounded-full bg-red-600 px-3 py-1 text-xs font-bold text-white">{step.title}</p>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-10">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {testimonials.map((item) => (
            <blockquote
              key={item.name}
              className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-[0_16px_50px_-38px_rgba(24,24,27,0.45)]"
            >
